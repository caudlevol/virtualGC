      ...
      <div className="max-w-5xl mx-auto space-y-8 pb-20">
        ...
        <div className="mt-10 pt-6 border-t border-white/10 print:mt-6 print:border-t print:border-gray-300">
          <p className="text-[11px] text-muted-foreground leading-relaxed max-w-3xl print:text-gray-600">
            ...
            VirtualGC recommends obtaining at least three licensed contractor bids before making renovation decisions. 
            VirtualGC, its agents, and affiliates are not liable for differences between estimated and actual project costs.
          </p>
          <p className="text-[10px] text-muted-foreground/60 mt-2 print:text-gray-400">
            Generated by VirtualGC on {format(new Date(quote.createdAt), 'MMMM d, yyyy')} &bull; Quote ID: {quote.id}
          </p>
        </div>
      </div>
    </AppLayout>
