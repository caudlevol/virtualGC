...
router.post("/demo/estimate", demoLimiter, async (req, res): Promise<void> => {
  ...
  res.json({
    ...
    fallbackNotice: usedFallback
      ? "We couldn't fetch the exact property details for this listing. This estimate uses a comparable sample property in a similar region. Sign up to get precise estimates from real listing data."
      : null,
